...
def get_beam_width(image, centroid):
    image = np.array(Image.fromarray(image).convert('L')) #should be passed in grayscale as analysis frame. need to fix
